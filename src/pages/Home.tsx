...
export default function Home() {
  const [isHomeContainerScrolled, setIsHomeContainersScrolled] =
    useState<boolean>(false); // Home의 Top 값
  const homeContainer = document.getElementsByClassName("HomeContainer");
  const [homeContainerFromTop, setHomeContainerFromTop] = useState<number>(0);
  ...
  return (
    <>
      <div
        className={
          isHomeContainerScrolled
            ? "HomeContainer HomeContainerScrolled"
            : "HomeContainer"
        }
      >
